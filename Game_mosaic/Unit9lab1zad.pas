...
type
  TPzForm = class(TForm)
    ...
    Button3: TButton;
    Button2: TButton;
    Function ImageByNumber(num:integer):Timage; {Возвращает компонент с картинкой}
...
var
  PzForm: TPzForm;
  GX,GY: integer; {предыдущие координаты курсора}
  GG: boolean; {флаг активности}
...
begin
   ...
   If (ImageByNumber(1).Left=ImageByNumber(7).Left) and
      ...
      Begin
      GG:=False;
      ShowMessage('Изображение восстановлено!!!');
      End;
